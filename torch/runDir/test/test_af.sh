...
do
    ...
    do
        ...
        do
            echo -en 'af\tglove\t'$pairs'\t'$inputSize'\t'$iter'\t'
            devPairPath='../../pairFiles/glove'$pairs'_Dev.txt'
            trainPairPath='../../pairFiles/glove'$pairs'_Train.txt'
            modelPath='../params/af_'$pairs'_model_in'$inputSize'_lr0.5_il10000_vg_it'$iter'.th'
...
do
    ...
    do
        for iter in {500..10000..500}
        do
            echo -en 'af\tw2v\t'$pairs'\t'$inputSize'\t'$iter'\t'
            devPairPath='../../pairFiles/glove'$pairs'_Dev.txt'
            trainPairPath='../../pairFiles/glove'$pairs'_Train.txt'
            modelPath='../params/af_'$pairs'_model_in'$inputSize'_lr0.5_il10000_vv_it'$iter'.th'
