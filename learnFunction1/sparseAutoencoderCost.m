...
[aInput, zHidden, aHidden, zOutput, aOutput] = activations(data, W1, W2, b1, b2);

rho = sum(aHidden,2)./numSamples;

cost_squaredError = sum(sum(((aOutput-aInput).^2)./2))/numSamples;
...
% squared error part of gradient
...
% weight decay part of gradient

% sparsity part of gradient
