...
do
    for hiddenSize in 50 100 500 1000 5000
    do
        inFileName='learnFunction1/data/hypers/hyper_train_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.matrix' 
        outFileName='learnFunction1/data/hypers/hyper2_train_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.txt' 
        paste temp $inFileName > $outFileName 
    done
done
rm temp
...
#cut -f1 learnFunction1/data/oPl_100_hyper_Train.txt > temp
#for visibleSize in 100 
#do
#    for hiddenSize in 50 100 500 1000 5000
#    do
#        inFileName='learnFunction1/data/hypers/hyper_train_plurals_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.matrix' 
#        outFileName='learnFunction1/data/hypers/hyper_train_plurals_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.txt' 
#        paste temp $inFileName > $outFileName 
#    done
#done
#rm temp
#
#cut -f1 learnFunction1/data/oPl_100_hyper_Dev.txt > temp
#for visibleSize in 100 
#do
#    for hiddenSize in 50 100 500 1000 5000
#    do
#        inFileName='learnFunction1/data/hypers/hyper_plurals_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.matrix' 
#        outFileName='learnFunction1/data/hypers/hyper_plurals_v'$visibleSize'_h'$hiddenSize'_r0.01_l0.0001_b3.txt' 
#        paste temp $inFileName > $outFileName 
#    done
#done
#rm temp
